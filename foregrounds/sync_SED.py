...
def map_pysm(fgtype, freq_reference):  # Generate map at instrument frequencies
    ...
    if model_type == 'powerlaw':
        if fgtype == "s1" or fgtype == "s5":
            ...
            AI = np.array([sync.get_emission(freq_reference * u.GHz).to(u.uK_CMB,
...
I_nu_sync_s1 = PowerLawpysm(
    freq_fossil, AI_sync_s1[0, 0, :], betamap_sync_s1[0, :], None, nu0_sync)

AI_sync_s5, betamap_sync_s5, nu0_sync_s5 = map_pysm('s5', nu0_sync)
I_nu_sync_s5 = PowerLawpysm(
    freq_fossil, AI_sync_s5[0, 0, :], betamap_sync_s5[0, :], None, nu0_sync)

AI_sync_s7, betamap_sync_s7, gammamap_sync_s7, nu0_sync_s7 = map_pysm(
    's7', nu0_sync)
I_nu_sync_s7 = PowerLawpysm(
    freq_fossil, AI_sync_s7[0, 0, :], betamap_sync_s7[0, :], gammamap_sync_s7[0, :], nu0_sync)

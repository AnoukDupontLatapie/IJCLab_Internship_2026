...
from sync_SED import nu0_sync, data_s1_20, data_s1_80, data_s5_20, data_s5_80, data_s7_20, data_s7_80
import numpy as np
...
def fitPL(data):
    popt, pcov = sp.curve_fit(
        ...
        freq_fossil,
        data, maxfev=10000, sigma=sigma_bin)
    return popt, pcov


def fitPL7(data):
    popt, pcov = sp.curve_fit(
        lambda freq, A, beta, gamma: PowerLawpysm(
            freq, A, beta, gamma, nu0_sync),
        freq_fossil,
        data, p0=[10**2, -1, 0.1], maxfev=10000, sigma=sigma_bin)
    return popt, pcov


params1_20, _ = fitPL(data_s1_20)
params1_80, _ = fitPL(data_s1_80)
bestfits1_20 = PowerLawpysm(
    freq_fossil, params1_20[0], params1_20[1], None, nu0_sync)
bestfits1_80 = PowerLawpysm(
    freq_fossil, params1_80[0], params1_80[1], None, nu0_sync)

params5_20, _ = fitPL(data_s5_20)
params5_80, _ = fitPL(data_s5_80)
bestfits5_20 = PowerLawpysm(
    freq_fossil, params5_20[0], params5_20[1], None, nu0_sync)
bestfits5_80 = PowerLawpysm(
    freq_fossil, params5_80[0], params5_80[1], None, nu0_sync)

params7_20, _ = fitPL7(data_s7_20)
params7_80, _ = fitPL7(data_s7_80)
bestfits7_20 = PowerLawpysm(
    freq_fossil, params7_20[0], params7_20[1], params7_20[2], nu0_sync)
bestfits7_80 = PowerLawpysm(
    freq_fossil, params7_80[0], params7_80[1], params7_80[2], nu0_sync)
